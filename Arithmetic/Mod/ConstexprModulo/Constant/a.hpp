...
private:
  ...
  static constexpr const INT_TYPE_FOR_MOD g_memory_bound = 2e6;
  static constexpr const INT_TYPE_FOR_MOD g_memory_length = M < g_memory_bound ? M : g_memory_bound;

  static constexpr INT_TYPE_FOR_MOD g_Mm = M - 1;
  static constexpr int g_order = g_Mm;
  static constexpr int g_orderm = g_order - 1;
