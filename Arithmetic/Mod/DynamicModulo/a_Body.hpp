...
template <int NUM> inline DynamicMods<NUM>& DynamicMods<NUM>::Invert() { m_n = Constants::g_M_is_prime && m_n < Constants::g_memory_length ? Inverse( int( m_n ) ).m_n : ModularInverse( Constants::g_M , move( m_n ) ); return *this; }
