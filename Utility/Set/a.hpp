...
DECLARATION_OF_UNION_FOR_SET( set<T> );
DECLARATION_OF_UNION_FOR_SET( unordered_set<T> );
DECLARATION_OF_UNION_FOR_SET( multiset<T> );
DECLARATION_OF_UNION_FOR_SET( unordered_multiset<T> );
DECLARATION_OF_UNION_FOR_SET( vector<T> );
DECLARATION_OF_UNION_FOR_SET( list<T> );
