...
template <typename INT> inline bool Online( const pair<INT,INT>& v0 , const pair<INT,INT>& v1 , const pair<INT,INT>& v2 , const INT& epsilon = 0 );
...
template <typename INT> inline int IntersectionType( const pair<INT,INT>& v0 , const pair<INT,INT>& v1 , const pair<INT,INT>& v2 , const pair<INT,INT>& v3 , const INT& epsilon = 0 );
