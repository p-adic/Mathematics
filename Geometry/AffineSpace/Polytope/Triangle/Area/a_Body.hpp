// c:/Users/user/Documents/Programming/Mathematics/Geometry/AffineSpace/Polytope/Triangle/Area/a_Body.hpp
...
inline double Area( const double& l0 , const double& l1 , const double& l2 ) { const double s = ( l0 + l1 + l2 ) / 2; return sqrt( max( s * ( s - l0 ) * ( s - l1 ) * ( s - l2 ) , 0.0 ) ); }
