// c:/Users/user/Documents/Programming/Mathematics/Polynomial/FormalPowerSeries/IteratedArithmetic/a_Body.hpp
...
FormalPowerSeries<T>& Prod( V<FormalPowerSeries<T>>& f )
{
  ...
  DEFIINTION_OF_PROD( Prod( f ) , FormalPowerSeries<T>( 1 , Polynomial<T>::one() ) , t += *itr );
