// c:/Users/user/Documents/Programming/Mathematics/Polynomial/FormalPowerSeries/IteratedArithmetic/a.hpp
...
template <typename T> FormalPowerSeries<T> Power( const FormalPowerSeries<T>& f , const int& e );
