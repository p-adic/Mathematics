// c:/Users/user/Documents/Programming/Mathematics/Polynomial/NonFFT/FPS/a.hpp

#pragma once
#include "../a.hpp"

// FFT要素を除去した版。
// template <typename T> FormalPowerSeries<T>& FormalPowerSeries<T>::operator*=( Polynomial<T> f );
// のみ定義が変わる。
