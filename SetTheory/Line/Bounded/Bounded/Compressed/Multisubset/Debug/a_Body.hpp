...
template <typename INT1 , typename INT2> inline CompressedSortedMultiSet<INT1,INT2>::CompressedSortedMultiSet( const vector<INT>& query , const bool& output_mode ) : VirtualBoundedLineMultiSubset<INT,const int&,const INT&>() , m_sorted_coord() , m_sorted_coord_inv()
{
