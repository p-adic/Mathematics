...
template <typename INT1 , typename INT2 , typename RET_NOR , typename RET_DEN , template <typename...> typename DATA_STR> inline VirtualBoundedLineSubset<INT1,INT2,RET_NOR,RET_DEN,DATA_STR>::VirtualBoundedLineSubset() : Debug() , m_lbound() , m_ubound() , m_ds( 0 , false ) , m_name() , m_S() {}

template <typename INT1 , typename INT2 , typename RET_NOR , typename RET_DEN , template <typename...> typename DATA_STR> inline void VirtualBoundedLineSubset<INT1,INT2,RET_NOR,RET_DEN,DATA_STR>::insert( const INT1& i )
{
...
template <typename INT1 , typename INT2 , typename RET_NOR , typename RET_DEN , template <typename...> typename DATA_STR> inline void VirtualBoundedLineSubset<INT1,INT2,RET_NOR,RET_DEN,DATA_STR>::erase( const INT1& i ) noexcept 
{
...
template <typename INT1 , typename INT2 , typename RET_NOR , typename RET_DEN , template <typename...> typename DATA_STR> inline void VirtualBoundedLineSubset<INT1,INT2,RET_NOR,RET_DEN,DATA_STR>::clear()
{
...
template <typename INT1 , typename INT2 , typename RET_NOR , typename RET_DEN , template <typename...> typename DATA_STR> inline INT2 VirtualBoundedLineSubset<INT1,INT2,RET_NOR,RET_DEN,DATA_STR>::IntervalCount( const INT1& i_start , const INT1& i_final )
{
...
template <typename INT1 , typename INT2 , typename RET_NOR , typename RET_DEN , template <typename...> typename DATA_STR> void VirtualBoundedLineSubset<INT1,INT2,RET_NOR,RET_DEN,DATA_STR>::Display() noexcept
{
...
template <typename INT1 , typename INT2 , template <typename...> typename DATA_STR> inline AbstractBoundedLineSubset<INT1,INT2,DATA_STR>::AbstractBoundedLineSubset( const INT1& lbound , const INT1& ubound , const bool& output_mode )
{
  ...
  static int count = 0;
  this->m_name = "AbstractBoundedLineSubset" + to_string( count++ );
