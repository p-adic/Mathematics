...
public:
  ...
  using iterator = IteratorOfBoundedLineSubset<VirtualBoundedLineMultiSubset<INT1,INT2,RET_NOR,RET_DEN,DATA_STR>,INT1>;
...
public:
  inline BoundedLineMultiSubset( const INT1& lbound , const INT1& ubound , const bool& output_mode = true );
